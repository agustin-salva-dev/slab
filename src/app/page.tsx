    ...
    <main className="relative min-h-screen h-screen w-screem px-32">
      ...
      <div className="relative flex flex-col justify-center h-full text-white gap-28">
        <section className="flex flex-col gap-14">
          <h1 className="text-8xl font-bold text-center tracking-tighter">The foundation for <br />
            your <span className="font-power tracking-tight">digital reach.</span></h1>
        ...
        <section className="flex items-center justify-center gap-12">
          <Button variant="secondary" size="sm" subject="icon-text" className="cursor-pointer">
            <Image
              src="/logo.webp"
              alt="Slab Logo"
              width={16}
          ...
          <Button variant="outline" size="sm" subject="icon-text" className="cursor-pointer">
            <Github size={16} />
            Give me a Star
          </Button>
        </section>
