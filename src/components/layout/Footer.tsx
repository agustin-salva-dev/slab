...
export default function Footer() {
    return (
        <footer className="absolute bottom-0 w-screen py-3.5 px-6 md:px-32 bg-my-primary flex flex-col md:flex-row items-center justify-between text-xs font-bold">
