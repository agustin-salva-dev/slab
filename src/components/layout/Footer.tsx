...
export default function Footer() {
  return (
    <footer className="fixed bottom-0 w-screen h-11 bg-my-primary flex flex-col md:flex-row md:px-32 items-center justify-center md:justify-between text-xs font-bold">
      <section className="flex items-center gap-3.5">
        <MessageCircleHeart className="text-my-accents-red" size={20} />
        <p>
          <span className="font-normal">Made by</span>{" "}
          <span className="cursor-pointer">Agvstindev</span>{" "}
          <span className="text-my-secondary font-normal">
            - inspired by Slug: by <span className="font-bold">Pheralb</span>
          </span>
        </p>
      </section>
      ...
      <section className="hidden md:flex items-center gap-12">
